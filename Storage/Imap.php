...
<<<<<<< HEAD
     ...
     * @throws \Zend\Mail\Protocol\Exception\RuntimeException
     */
    public function getMessage($id, $extraItems = array())
    {
...
<<<<<<< HEAD
        ...
        $params = array('handler' => $this, 'id' => $id, 'headers' => $header, 'flags' => $flags);

        foreach ($extraItems as $k => $v)
        {
            // Prevent to override existing params
            if (!isset($params[$k])) {
                $params[$k] = $data[$v];
            }
        }
